...
class PaymentHistory extends StatefulWidget {
  const PaymentHistory(this.huid, {Key? key}) : super(key: key);
  final String? huid;
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: ListTile(
                  leading: Icon(
                    isRefunded == false ? Icons.arrow_circle_up_rounded:Icons.arrow_circle_down_rounded,
